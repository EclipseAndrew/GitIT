...
function f4() {
  let a = document.querySelector(".out-4"); // кнопка
...
function f5() {
  let previousClass = document.querySelector(".out-4");
  let result = document.querySelector(".out-5");

  if (previousClass.classList.contains("bg-orange")) {
...
function f6() {
  let quantity = document.querySelectorAll(".p-6").length;
  document.querySelector(".out-6").innerHTML = quantity;
}
...
function f18() {
  let div18 = document.querySelector(".p-18");
  let content = div18.getAttribute("data-b");
  document.querySelector(".out-18").innerHTML = content;
}
...
function f19() {
  ...
  for (let i = 0; i < div19.length; i++) {
    let attribute = div19[i].getAttribute("data-b");
    result += attribute + " ";
  }
