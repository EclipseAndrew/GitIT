...
let ar1 = [32, 1412, 1234, 1234, "asd", "34q", "342", 0, " ", true, " ", 3];
//'&nbsp(бо простий пробіл ігнорується якщо він останній)'
function f1() {
...
let ar2 = [32, 1234, 1234, "asd", "34q", "342", 0, "&nbsp", "' '", true, " "];
...
let ar3 = [32, 1412, 1234, 1234, "asd", "34q", "342", 0, "&nbsp", true, " ", 3];
function f3() {
...
let ar4 = [32, 1412, 1234, 1234, "asd", "34q", "342", 0, '" "', true, " ", 3];

function f4() {
  let fewIndexes = `${ar4[0]} ${ar4[3]} ${ar4[8]}`;
  document.querySelector(".out-4").innerHTML = fewIndexes;
}
...
let ar5 = [32, 1412, 1234, "asd", "34q", "342", 0, '" "', true, " ", 3];

function f5() {
  let valueSum = ar5[0] + ar5[2] + ar5[3];
  document.querySelector(".out-5").innerHTML = valueSum;
}
...
let ar6 = ["Євкакій", "Рак", 12, "07"];

function f6() {
  let valueOFArr = `${ar6[0]} ${ar6[1]} ${ar6[2]} ${ar6[3]}`;
  document.querySelector(".out-6").innerHTML = valueOFArr;
}
...
let ar8 = [];
// Прошу, допишіть в умову задачі приклад виводу (undefined-undefined-undefined-3.14-17-undefined-5-) щоб наступним поколінням було більше зрозуміліша умова виконання завдання. Дякую.
function f8() {
  ar8[3] = 3.14;
  ar8[4] = 17;
  ar8[6] = 5;
...
function f10() {
  ...
  let secondIndex = ar10.length - lastIndex;
  let sumOfIndexes = ar10[secondIndex] + ar10[lastIndex];

  document.querySelector(".out-10").innerHTML = sumOfIndexes;
  //console.log(lastIndex, secondIndex);
}
...
function f12() {
  let switcher = ar12[ar12.length - 1];
...
function f13() {
  ...
  for (let i = 0; i < ar13.length; i++) {
    outputKeyValues.push(`${i} ${ar13[i]} `);
  }
  document.querySelector(".out-13").innerHTML = outputKeyValues.join("");
  //console.log(outputKeyValues);
}
...
function f14() {
  ...
  for (; i >= 0; i--) {
    reversArr.push(ar14[i]); //або, можна було через unshift(брати наступний елемент масиву і добавляти його на початок)
    // console.log(reversArr)
  }

  document.querySelector(".out-14").innerHTML = reversArr.join(" ");
}
...
function f15() {
  ...
  for (let i = 0; i < ar15.length; i++) {
    ar15[i] > 0
      ? positiveFigures.push(ar15[i])
      : 'Офіційне місце для "отсєбятіни"'; // :)
    //   if(ar15[i] > 0){
    //     positiveFigures.push(ar15[i])
    //   }
  }

  document.querySelector(".out-15").innerHTML = positiveFigures.join(" ");
  // console.log(positiveFigures)
}
...
function f16() {
  for (let i = 0; i < ar16.length; i++) {
    ar16[i] % 2 ? ar16_odd.push(ar16[i]) : ar16_even.push(ar16[i]); // ...цікаво виходить, остача = 1(true), а якщо остачі немає = 0(false).
  }
...
function f18() {
  let theBiggestInt = ar18[0]; // або -Infinity

  for (let i = 0; i < ar18.length; i++) {
    if (ar18[i] > theBiggestInt) {
      theBiggestInt = ar18[i];
    }
    // console.log(theBiggestInt)
  }
  document.querySelector(".out-18").innerHTML = theBiggestInt;
}
...
function f20() {
  ...
  document.querySelector(".out-20").innerHTML = totalSum;
}
