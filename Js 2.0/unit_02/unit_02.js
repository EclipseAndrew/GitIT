...
const e1 = "3",
  f1 = 5;
document.querySelector(".out-4").textContent = e1 + f1; //Відбувається конкатенація e1(тип данних "рядок") та автоматичне послідуюче перетворення наступних типів даних до таких що задовільняють умову взаємодії типів данних в JS... а тепер нормальною мовою. Js читає вміст коду з ліва на право, і який тип бачить таким і починає маніпулювати (приклад: 5+5=10; 5+5+"6"=106;"6"+5+5=655)
...
function t9() {
  ...
  data = document.querySelector(".i-9").value = "";
}
...
function t12() {
  ...
  let secondName = document.querySelector(".i-12-2").value;
  document.querySelector(".out-12").innerHTML = `Hello ${name} ${secondName}`;
}
...
function t13() {
  ...
  document.querySelector(".out-13").innerHTML = a + b; // = +a + +b;
}
