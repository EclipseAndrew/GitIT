...
function f4() {
  let doesChecked = document.querySelector(".i-4").checked;
  let output;
  //console.log(doesChecked);
  ...
  document.querySelector(".out-4").innerHTML = output;
}
...
function f5() {
  let doesChecked2 = document.querySelector(".i-5");
  let output;
  //console.log(doesChecked2);

  if (doesChecked2.checked) {
    output = doesChecked2.value;
  } else {
    output = false;
  }
...
function f7() {
  ...
  document.querySelector(".out-72").innerHTML = symbolLenght;
}
...
function f8() {
  ...
  newDiv.className = "js3"; //(або).classList.add("js2");
  newDiv.innerHTML = "new div";
  let parentEllem = document.querySelector(".out-8");
  parentEllem.appendChild(newDiv);
  //console.log(newDiv);
  //створюєм новий div в html сторінці в самому браузері (і там її і зберігає(до оновлення)).
}
...
function f16() {
  ...
  let option = document.querySelector(".s-16").value;
  document.querySelector(".out-16").innerHTML = option;
  //console.log(option);
}
...
function f17() {
  let option = document.querySelector(".s-17").value;
  document.querySelector(".out-17").innerHTML = option;
}
...
function f18() {
  let option = document.querySelector(".s-18").value;
  document.querySelector(".i-18").value = option;
  console.log(option);
}
...
function f19() {
  let option = document.querySelector("div.out-19").textContent;
  document.querySelector(".i-19").value = option;
  // console.log(option);
}
...
function f20() {
  let option = document.querySelector(".s-201").value;
  document.querySelector(".s-202").value = option;
}
