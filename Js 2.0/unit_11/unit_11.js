...
function f1() {
  let getInput = document.querySelector(".i-1").value;
  d1.push(getInput);
...
function f4() {
  let getInput = document.querySelector(".i-4").value;
  d1.push(getInput);
...
function f5() {
  let getInput = document.querySelector(".i-5").value;
  d1.unshift(getInput);
  showArr(".out-5", d1);
}
...
function f6() {
  let getInput = document.querySelector(".i-6").value;
  d6[d6.length] = getInput;
...
function f11() {
  ...
  let index = d11.indexOf(inputValue);
