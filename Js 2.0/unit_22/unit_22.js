...
function t3() {
  ...
  } catch /*(err)*/ {//і можна без параметрів помилки.
    const parent = document.querySelectorAll("section")[2];
  ...
  document.querySelector(".out-3").innerHTML = a * b; // або без цього рядка (але тоді потрібно буде викликати функцію двічі).
}
