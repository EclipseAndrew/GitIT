...
function t5(yourName) {
  ...
  //   let yourName2 = prompt();
  //   console.log(yourName2.length);

  return /*yourName2.length ||*/ yourName.length;
}
...
function t6(a, b) {
  return Math.floor(Math.random() * (b - a + 1)) + a; //https://www.w3schools.com/js/js_random.asp
}
