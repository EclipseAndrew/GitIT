...
function t1(min, max) {
  ...
  document.querySelector(".out-1").innerHTML = randomNumber;
}
...
function t3(min = 0, max = 100) {
  document.querySelector(".out-3").innerHTML = Math.floor(
...
function t7(arr = [], block) {
  Array.isArray(arguments[0])
    ? (arguments[1].innerHTML = arguments[0].join(" "))
    : (arguments[1].innerHTML = false);
}
