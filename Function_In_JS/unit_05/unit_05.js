...
let res2;
res2 = ar1.map((e) => e ** 3); // сюда в скобки дописываете стрелочную функцию
...
const ar3 = [4, "5", 6];
let res3;
let callBack3 = (e) => typeof e === "number";
...
let res4;
res4 = ar3.filter((e) => typeof e === "number"); // сюда в скобки дописываете стрелочную функцию
