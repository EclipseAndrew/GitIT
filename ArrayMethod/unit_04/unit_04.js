...
const f2 = () => {
  ...
  const toCube = input ** 3;
  a2.unshift(input, toCube);
  console.log(a2);
};
...
const f3 = () => {
  ...
  console.log(a3.unshift(input)); // виводим довжину всього масиву (з вже добавленим елементом)
  console.log(a3); // саме тіло масиву
};
...
const f5 = () => {
  return a5.shift(); //повертє видалений елемент
};
...
const f10 = () => { console.log(a10.slice(2,-2));};
