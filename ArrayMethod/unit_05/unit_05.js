...
const f9 = () => {
  a9_even = a9.filter((e) => e % 2 === 0); // поправте умову задачі
  a9_index = a9.map((e, i) => i);
  console.log(a9_even);
...
//. Функция коллбек должна принимать только один параметр - текущий элемент. Примените вашу функцию так, чтобы на основе массива a10, функция f10 создала массив a20_res, который содержит элементы a10 умноженные на 2. В качестве коллбека примените-напишите callback10;
