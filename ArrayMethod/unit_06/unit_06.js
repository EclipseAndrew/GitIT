...
const f4 = () => {
  z4 = a4.filter((e) => typeof e !== "number"); // написав...( typeof number !== e ) і думаю в чом проблема??
  console.log(z4);
};
...
const f8 = () => {
  a8.filter((e) => (e % 2 === 0 ? z8.push(e) : z8_2.push(e)));
  console.log(z8);
  console.log(z8_2);
};
...
const f9 = () => {
  for (let i of a9) {
    // це завдання точно не про filter, правда?
    z9[i] = i;
  }
  console.log(z9);
};
...
const f10 = () => {
  for (let key in a10) {
    ...
    a10[key] > 5 || a10[key] < -5 ? (z10[key] = a10[key]) : 0; // або через Math.abs(value) > 5
  }
  console.log(z10);
};

function callback10(elem) { 
  // ваш код           // хз якщо чесно ( якщо це не просто так тут тоді повертайте Bug )
  // return
}
